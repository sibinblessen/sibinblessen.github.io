...
function About({ language }) {
    ...
    return (
        <section id="about" className="hero-section" aria-label={content.ariaLabel}>
            <aside className="right-float-container" aria-label={content.socialLinks}>
                <nav className="social-link-container" role="navigation" aria-label={content.socialNavigation}>
                    <ul>
                        <li className="social-link">
                            <a href="https://www.linkedin.com/in/sibin-blessen/" target="_blank"
                                rel="noopener noreferrer" className="social-link-icon" 
                                aria-label={content.linkedInNewTab}
                                title={content.linkedInTitle}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 512 512" aria-hidden="true">
                                    <path
                        ...
                        <li className="social-link">
                            <a href="https://github.com/sibinblessen/" target="_blank" rel="noopener noreferrer"
                                ...
                                aria-label={content.githubNewTab}
                        ...
                        <li className="social-link">
                            <a href="mailto:sibinblessen@gmail.com" target="_blank" rel="noopener noreferrer"
                                className="social-link-icon" 
                                aria-label={content.emailNewTab}
            ...
            <div className="content-container">
                ...
                <article className="bio-container">
                    <header className="greeting-container">
                        <p className="hero-overline">{content.overline}</p>
                    ...
                    <div className="position-container">
                        <h2 className="position" itemProp="jobTitle">{content.position}</h2>
                    </div>
                    ...
                    <ul className="hero-meta" aria-label={content.coreExperience}>
                        <li><strong>8+</strong> {content.years}</li>
                    ...
                    <nav className="mobile-social-container" aria-label={content.mobileSocialLinks}>
                        <div className="mobile-social-links">
                            <a href="https://www.linkedin.com/in/sibin-blessen/" 
                               ...
                               title={content.linkedInTitle}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 512 512" aria-hidden="true">
